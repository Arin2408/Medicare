            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  quia earum amet architecto, modi odio. Soluta undeducimus
                  perferendis?
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                Find a nearby doctor available from your location in minutes.
                </p>
                <Link
                  to="/doctors"
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Doctors available at nearby locations are now easy to find.
                </p>
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full  border border-solid border-[#181A1E]  mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none"
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Booking made easy. Select the slot and book according your convinence.
                </p>
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full  border border-solid border-[#181A1E]  mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none"
